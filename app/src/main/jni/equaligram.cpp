...
extern "C"
{
	...
	JNIEXPORT jobject JNICALL Java_com_ganesus_equaligram_MainActivity_genHistogram (JNIEnv * env, jobject obj, jobject bitmem, jobject canvas, bool isGrayScale);
	JNIEXPORT jobject JNICALL Java_com_ganesus_equaligram_MainActivity_createGrayscale (JNIEnv * env, jobject obj, jobject bitmem);
